...
<?php 
 ...
 ?>
		<span class="icon"><?= Html::a('<i class="icon icon icon-home" style="color:#fff"></i>', $linkHome, ['title' => Yii::t('app', $data['TITLE']),'class' => '','style'=>'padding:0 2px;']) ?></span>
	 ...
	 <?php } ?>
	<?php 
	    if((isset($action) && $action =="index" && in_array('download', $arrActions))){
 ...
 ?>
	<span class="icon"><?= Html::a('<i class="icon icon icon-pencil" style="color:#fff"></i> ', $linkCreate, ['title' => Yii::t('app', 'Thêm mới'),'class' => '','style'=>'padding:0 2px;']) ?></span>
 <?php 
 ...
 ?>
	...
	<?php 
	 ...
	 ?>
     	<span class="icon"><?= Html::a('<i class="icon icon icon-eye-open" style="color:#fff"></i>', $linkView, ['title' => Yii::t('app', 'Xem chi tiết'),'class' => '','style'=>'padding:0 2px;']) ?></span>
   	<?php } ?>
<?php 
...
?>
	...
	<?php 
	 ...
	 ?>
     <span class="icon"><?= Html::a('<i class="icon icon icon-edit" style="color:#fff"></i>', $linkUpdate, ['title' => Yii::t('app', 'Cập nhật'),'class' => '','style'=>'padding:0 2px;']) ?></span>
	<?php } ?>	
