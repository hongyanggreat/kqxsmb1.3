...
namespace backend\modules\userOnline\controllers;

use Yii;
use backend\modules\userOnline\models\Useronline;
use backend\modules\userOnline\models\UseronlineSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * DefaultController implements the CRUD actions for Useronline model.
 */
