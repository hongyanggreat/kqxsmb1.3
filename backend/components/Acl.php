...
class Acl 
{
    ...
    function getAllPermissions(){
        ...
        $resultUserPermissions = UserPermission::find()
                                    ->select(['tbl_user_permission.ALL_RIGHT','tbl_user_permission.LIST_RIGHT','tbl_user_permission.VIEW_RIGHT','tbl_user_permission.ADD_RIGHT','tbl_user_permission.EDIT_RIGHT','tbl_user_permission.DEL_RIGHT','tbl_user_permission.UP_RIGHT','tbl_user_permission.DOWN_RIGHT','tbl_user_permission.MODULE_ID','m.RESOURCE'])
                                    ->asArray()
                                    ->leftJoin('tbl_modules m', 'm.MODULE_ID=tbl_user_permission.MODULE_ID')
                                    ->where(['tbl_user_permission.ACC_ID' => $idUser])
                                    ->all(); 
